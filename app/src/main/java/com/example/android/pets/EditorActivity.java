...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    private void saveData(){
        ...
        if(currentPetUri == null){
            ...
            if ( TextUtils.isEmpty(nameString) || TextUtils.isEmpty(breedString) || mGender == PetContract.PetEntry.GENDER_UNKNOWN) {return;}
            ...
            values.put(PetContract.PetEntry.COLUMN_PET_GENRE,mGender);
            ...
            if (newRowUri == null) {
                ...
                Toast.makeText(this,"Pet Saved",Toast.LENGTH_LONG);
            }
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        String Projection[] = {PetContract.PetEntry._ID,
                              PetContract.PetEntry.COLUMN_PET_NAME,
                                ...
                                PetContract.PetEntry.COLUMN_PET_GENRE,
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        if(data.moveToFirst()) {
            int nameIdIndex = data.getColumnIndex(PetContract.PetEntry.COLUMN_PET_NAME);
            int breedIndex = data.getColumnIndex(PetContract.PetEntry.COLUMN_PET_BREED);
            int genreIndex = data.getColumnIndex(PetContract.PetEntry.COLUMN_PET_GENRE);
